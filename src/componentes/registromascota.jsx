                    ...
                    <form action="" onSubmit={handleSubmit(enviar)}>
                        ...
                        <div class="bienvenida-1">
                            ...
                            <div>
                                ...
                                <input className="input-1" type="number" id="edad" placeholder="Ingresa la Edad " {...register("edad")}/>
                        ...
                        <div className="bienvenida-1">
                            ...
                            <select className="input-2" name="Cantidad Vacunas" id="checkbox1" {...register("cantidad1")}>

                                <option className="input-2" value="" ></option>
                                <option className="input-2" value="1" >1</option>
                                <option className="input-2" value="2" >2</option>
                                <option className="input-2" value="3" >3</option>
                                <option className="input-2" value="4" >4</option>
