            ...
            <details>
              ...
              <nav className="menus">
                <ul className="ul-menu1" id="categorias">
                  ...
                  <li>
                    <input type="checkbox" id="bistop" />
                    <label className="label-check1" htmlFor="bistop">
                      Bistop
                    </label>
                  </li>
                  <li>
                    <input type="checkbox" id="baytril" />
